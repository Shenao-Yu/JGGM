...
#%% cmd parameters setting
argparser = argparse.ArgumentParser("JGGM",
                                    formatter_class=argparse.ArgumentDefaultsHelpFormatter)
argparser.add_argument("--dataset", type=str, default='dblp')#dblp
...
argparser.add_argument("--para-init", type=str, default='rand')# 'orth' 'rand'
argparser.add_argument("--feat-init", type=str, default='cluster') # 'cluster' 'sample'
argparser.add_argument("--seed", type=int, default='0') # 'seed'
args = argparser.parse_args()
dataset = args.dataset#['dblp', 'imdb', 'acm', 'Yelp','freebase']
cond_rate = args.cond
...
####################################################
graphsyner, losses_log = JGGM(data, cond_rate, feat_init, para_init, basicmodel, model_architecture, cond_train)
#################################################
time_end=time.time()
...
accs,f1_micros,f1_macros = evalue_JGGM(5, data, x_syn_dict, adj_t_syn_dict, y_syn, mask_syn,
